...
@Controller
@RequestMapping("/depot/orderOut")
public class DepotOrderOutController {

    @Autowired
    DepotOrderOutService service;
    ...
    public IResult selectAll(String page, String limit,Integer orderType,String state){
        return new PageResultBean<Collection<DepotOrderOut>>(service.getAll(page,limit,orderType,state),service.countGetAll(orderType,state));
    }
    ...
    public IResult selectByPrimaryKey(String id){
       return new ResultBean<DepotOrderOut>(service.selectByPrimaryKey(id));
    }
    ...
    public IResult insert(String id, Integer orderType, String goodsId,
        ...
        return new ResultBean<DepotOrderOut>(service.insert(id,orderType,goodsId,goodsNumber,applyUser,
    ...
    public IResult getFirstMenuListState(){
        ...
        return new ResultBean<Collection<DepotOrderOut>>(service.getFirstClassListState());
    }
